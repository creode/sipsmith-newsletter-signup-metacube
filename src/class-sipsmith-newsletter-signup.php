...
class Sipsmith_Newsletter_Signup {
	 ...
	 */
	public function amend_newsletter_consent_checkbox_copy( $default_copy ) {
		/* translators: %s: Privacy Policy Link */
		return sprintf(
			__( 'I agree to receive occasional updates from the Sipsmith Distillery in line with the <a href="%s" target="_blank">Privacy Policy</a>.', 'sipsmith-newsletter-signup-copy' ),
			esc_url( 'https://www.beamsuntory.com/en/privacy-policy' )
		);
	}
