...
class Sipsmith_Newsletter_Signup {
	...
	public function amend_newsletter_consent_checkbox_copy( string $default_copy ) {
		return __( 'I agree to receive occasional updates from the Sipsmith Distillery in line with the <a href="/privacy-policy">Privacy Policy</a>.', 'sipsmith-newsletter-signup-copy' );
	}
